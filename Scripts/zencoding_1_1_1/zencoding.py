...
if abbr:
  if exp_type == 'exp':
    ...
    try:   # Need to get selected text
      ...
      selFile = open(selFileDest+'/Library/Application Support/TextWrangler/Scripts/zencoding_1_1_1/zen_selected_temp', 'r')
  ...
  if result:
    ...
    # Remove for first line
    result = re.sub(re.compile('^'+indent), r'', result)
